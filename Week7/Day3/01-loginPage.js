...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.loadurl = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: // url is a local variable to get the argument passed `http://leaftaps.com/opentaps/control/main`
    ...
    LoginPage.prototype.enterCredentials = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.locator("#username").fill(username)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.page.locator("#password").fill(password)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, login.enterCredentials("demoCSR2", "crmsfa")];
                case 5:
                    _a.sent();
